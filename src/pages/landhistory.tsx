  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Carbon Credits Transaction history" />
          ...
          <div className="flex flex-col text-center w-full">
            <div className="w-full py-4 overflow-x-hidden overflow-y-auto md:inset-0 justify-center flex md:h-full">
              <div className="relative w-full h-full md:h-auto">
                <div className="relative bg-green bg-opacity-20 rounded-lg shadow dark:bg-black dark:bg-opacity-20">
